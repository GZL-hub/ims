...
const StockCountCard: React.FC<StockCountCardProps> = ({
  ...
  return (
    <div className="bg-background-50 border border-background-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300 hover:border-primary-400">
      ...
      <div className="mt-4">
        <p className="text-text-600 text-sm font-medium">{label}</p>
