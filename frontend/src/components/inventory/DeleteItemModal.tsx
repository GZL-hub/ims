...
const DeleteItemModal: React.FC<DeleteItemModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100]">
      <div className="bg-white dark:bg-background-100 rounded-2xl shadow-2xl w-full max-w-md border border-background-200 dark:border-background-300 m-4">
        {/* Modal Header */}
        <div className="px-6 py-4 border-b border-background-200 dark:border-background-300">
        ...
        {/* Modal Footer */}
        <div className="flex justify-end gap-3 px-6 py-4 bg-background-50 dark:bg-background-100 border-t border-background-200 dark:border-background-300 rounded-b-2xl">
          <button
            type="button"
            onClick={onClose}
